...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<IceBlockEntity>> ICE_BLOCK = ENTITY_TYPES.register("ice_block", () -> {
        return EntityType.Builder.of(IceBlockEntity::new, MobCategory.MISC).sized(1.0f, 1.0f).setShouldReceiveVelocityUpdates(false).fireImmune().build("arcaneadditions:ice_block");
    });
}
